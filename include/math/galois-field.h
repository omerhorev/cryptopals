...
namespace math
{
    ...
    public:
        ...
        /**
         * Multiplies a constant to this number and return a new one that is the result of the operation.
         *
         * @param v The constant to multiply
         * @return (galois256) a new number that is this constant multiplied to the number provided
         */
        galois256 operator*(unsigned char v) const;
         ...
         * @return (galois256&) This value after the value change.
         */
        galois256 &operator=(unsigned char v);
